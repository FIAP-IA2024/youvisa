...
const fileSchema = new Schema<IFile>(
  {
    ...
    ocr_status: { type: String, enum: Object.values(ProcessingStatus), default: ProcessingStatus.PENDING },
    ocr_processed_at: { type: Date, required: false },
    ocr_error: { type: String, required: false },
